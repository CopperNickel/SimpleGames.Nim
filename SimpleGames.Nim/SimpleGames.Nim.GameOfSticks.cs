//---------------------------------------------------------------------------------------------------------------------
//
// Game of sticks (or 3-5-7 game).
// Two players take consequent sticks (at least 1, at most maxTake which is typically 3) from any single row.
// Who takes the last stick loses the game (in reversed game wins)
// Initial position is
//
//       | | |      (3 sticks)
//     | | | | |    (5 sticks)
//   | | | | | | |  (7 sticks)
//
//   Which we describe as an array {3, 5, 7}
//
//   Note, that matches can be taken from the same row in different ways. 
//   For instance, player can take 2 matches from the last rows as:
//
//  xx||||| (1st, 2nd taken) |xx|||| (2nd, 3d taken) ||xx||| (3d, 4th taken)
//   
// {3, 5, 5},             {3, 5, 1, 4},            {3, 5, 2, 3} positions
//
//---------------------------------------------------------------------------------------------------------------------
